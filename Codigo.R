...
accidentes_2016 %>% 
  rename(
    Numero_expedient = Num_exp, Nom_districte = Distrito, Nom_barri = Barrio, Nom_carrer = Calle, Num_postal = Cod_postal, 
    Descripcio_dia_setmana = Dia_semana,  Descripcio_tipus_dia = Dia_tipo, Any = Año, Mes_any = Mes, Dia_mes = Dia, Hora_dia = Hora, 
    Descripcio_torn = Momento_dia, Descripcio_causa_vianant = Causa_acc, Numero_morts 
  )

View(accidentes_2016)
